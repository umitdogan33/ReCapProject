    ...
    public class EfRentalDal : EfEntityRepositoryBase<Rental, ReCapContext>, IRentalDal
    {
        public List<RentalsDetailDto> GetAllDetails()
        {
            ...
            var result = from c in context.Rentals
                         ...
                         select new RentalsDetailDto { CarId = ax.CarId,BrandName=ac.BrandName,ColorName=cl.ColorName,
                         CustomerId=cs.Id,CustomerLastName=us.FirstName,CustomerCompanyName=cs.CompanyName,CustomerName=us.LastName,
                         DailyPrice=ax.DailyPrice,Email=us.Email,ModelYear=ax.ModelYear,RentalsId=c.Id,RentDate=c.RentDate,ReturnDate=c.ReturnDate
                         };
